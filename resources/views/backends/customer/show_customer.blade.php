    ...
    <div class="table-responsive">
      ...
      @foreach($categorys as $item)
          <tr>
            ...
            <td>
              <a href="{{Route('edit.category',$item->id )}}" class="active" ui-toggle-class=""><i class="fas fa-edit"></i>
               </a>
               <a onclick="alert('bạn có chắc muốn xóa không?')"
                href="{{Route('deleted.categorys',$item->id )}}" class="active" ui-toggle-class=""><i class="fas fa-trash-alt"></i>
               </a>
            </td>
          </tr>
      @endforeach
