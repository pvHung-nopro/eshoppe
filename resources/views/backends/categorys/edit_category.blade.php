    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                @endif
                <div class="form">
                    <form class="cmxform form-horizontal " id="signupForm" method="post" action="{{Route('post.edit.categorys',$categorysId->id)}}" novalidate="novalidate">
                        @csrf
                        <div class="form-group ">
                            <label for="firstname" class="control-label col-lg-3">category name</label>
                            <div class="col-lg-6">
                                <input class=" form-control" id="firstname" name="name" type="text" value="{{ $categorysId->name ?? null}}">
                            </div>
                            <p class="help is-danger errors_sub">{{ $errors->first('name') }}</p>
                        </div>

                        <div class="form-group ">
                            <label for="lastname" class="control-label col-lg-3">slug category</label>
                            <div class="col-lg-6">
                                <input class=" form-control" id="lastname" name="slug" type="text" value="{{ $categorysId->slug ?? null}}">
                            </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control " id="username" name="title" type="text" value="{{ $categorysId->meta_title ?? null}}">
                            </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control " id="password" name="desc" type="text" value="{{ $categorysId->meta_desc ?? null}}">
                            </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control " id="confirm_password" name="keyword" type="text" value="{{ $categorysId->meta_keyword ?? null}}">
                            </div>
