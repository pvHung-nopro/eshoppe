                        ...
                        <div class="col-sm-4">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                        ...
                                        <h2>${{floatval($product->price) ?? null }}</h2>
                                        <p>{{$product->name ?? null}}</p>
                                        ...
                                        <div class="product-overlay">
                                            ...
                                            <p>{{$product->name ?? null }}</p>
                                            <a href="{{Route('frontend.cart.store',$product->id)}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                            </div>
                                        </div>
                                </div>
                                <div class="choose">
                                    <ul class="nav nav-pills nav-justified">
                                        ...
                                        <li><a href="{{Route('product.details',$product->id)}}"><i class="fa fa-plus-square"></i>Xem chi tiết sản phẩm</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
